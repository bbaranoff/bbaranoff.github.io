...
et même un **baseband émulé** (voir [module 8](8-QEMU-Calypso.md)). Aucun matériel
...
Calypso entièrement émulé** — le [module 8](8-QEMU-Calypso.md) lui est consacré.
...
*Suite du module : [8 — Émulation du baseband Calypso (QEMU-Calypso)](8-QEMU-Calypso.md).*
