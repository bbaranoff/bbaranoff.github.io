Voici un guide détaillé pour installer Git sur Ubuntu et effectuer diverses opérations Git comme **push**, **pull**, **commit**, **fork**, **force push**, **checkout**, **branches**, et **merge**.
