...
>>>>>>> 3caf3436d62d8c6baf268aee7f040e0eca01ce63
...
(Fooling MS : Mobile Station, the 2G phone) The MS doesn’t ask
authentication from BTS (Base Transceiver Station, the relay antenna).
So what to do to intercept ? Be a BTS… and that’s all just spoof the
public values of the BTS (mcc,mnc exemple 208,15 for FreeMobile 208,01
for Orange, etc) and broadcast a stronger signal and it is done. How the
implement a 2G BTS ? there are open sourced implementation on github.  
<https://github.com/osmocom> (OpenBSC Osmo-Trx Osmo-Bts… EOL but
usefull) or (Network in the Box Updated)  
<https://github.com/RangeNetworks/openbts> <https://github.com/vir/yate>
...
[IMSI-Catcher 2G](assets/https://www.youtube.com/watch?v=gHKmmVZAaFo)
...
[Redirection Attack](assets/https://www.youtube.com/watch?v=gHKmmVZAaFo)
...
[![Attack Flow](assets/test3.png)](assets/test3.png)
...
[Impersonnate PoC](assets/https://www.youtube.com/watch?v=gHKmmVZAaFo)
...
\`\`\` {.sourceCode .} bsc-2rfa 172.17.0.2 server rand 888 listen on
0.0.0.0 client sres 666 -\> 172.17.0.3

bb-2rfa 172.17.0.3 client rand 888 -\> 172.17.0.2 server sres 666 listen
on 0.0.0.0 server kc 777 listen on 0.0.0.0
...
newpage [Redirection
Attack](assets/https://www.youtube.com/watch?v=gHKmmVZAaFo)
...
#APOGÉ - l’intelligence Artificielle en Périphérie pOur l’aGriculture de
...
APOGÉ utilise des algorithmes d’apprentissage automatique pour analyser
